...
window.cash = function () {
    ...
    var _ = y.fn = y.prototype = g.prototype = {cash: !0, length: 0, push: s, splice: t.splice, map: t.map, init: g};
    ...
    function C(t) {
        return y(r.call(t).filter(function (t, e, i) {
            return i.indexOf(t) === e
        }))
    }

    Object.defineProperty(_, "constructor", {value: y}), y.parseHTML = f, y.noop = e, y.isFunction = h, y.isString = d, y.extend = _.extend = function (t) {
        t = t || {};
        ...
        merge: function (t, e) {
            ...
            return t.length = n, t
        }, each: b, matches: k, unique: C, isArray: Array.isArray, isNumeric: function (t) {
    ...
    _.extend({
        data: function (e, i) {
            if (d(e)) return void 0 === i ? L(this[0], e) : this.each(function (t) {
                return x(t, e, i)
            });
            ...
            return this.each(function (t) {
                return i = s, void ((n = M(e = t)) ? delete n[i] : e.dataset ? delete e.dataset[i] : y(e).removeAttr("data-" + name));
                var e, i, n
            })
        }
    });
    ...
    _.extend({
        ...
        add: function (t, e) {
            ...
            if (!e) return this;
            var i = h(e) ? e : w(e);
            return y(n.call(this, function (t) {
                return i(t, e)
            }))
        }, first: function () {
            return this.eq(0)
    ...
    function q(e, i, t) {
        var n, s = L(e, "_cashEvents"), o = s && s[i];
        o && (t ? (e.removeEventListener(i, t), 0 <= (n = o.indexOf(t)) && o.splice(n, 1)) : (b(o, function (t) {
    ...
    function z(t) {
        ...
        switch (s.toLowerCase()) {
            ...
            case"select-multiple":
                return e = [], b(t.options, function (t) {
    ...
    y.prefixedProp = j, y.camelCase = W, _.extend({
        css: function (e, i) {
        ...
        off: function (e, i) {
            ...
            var n;
            if (d(a)) return h(i) && (r = i, i = null), "ready" === a ? (m(r), this) : (i && (n = r, r = function (t) {
                ...
                }), i = a, n = o, (s = L(e = t, "_cashEvents") || x(e, "_cashEvents", {}))[i] = s[i] || [], s[i].push(n), e.addEventListener(i, n)
            }));
    ...
    return _.extend({
        ...
        children: function (e) {
            ...
            var i, n = [];
            return this.each(function (t) {
                for (i = t; i && i.parentNode && i !== o.body.parentNode;) i = i.parentNode, (!e || e && k(i, e)) && n.push(i)
            }), C(n)
        }, prev: function () {
    ...
    "function" == typeof define && define.amd ? define([], function () {
        return t.Waves = e.call(t), document.addEventListener("DOMContentLoaded", function () {
            t.Waves.init()
        }, !1), t.Waves
    }) : "object" == typeof exports ? module.exports = e.call(t) : (t.Waves = e.call(t), document.addEventListener("DOMContentLoaded", function () {
        t.Waves.init()
    }, !1))
}("object" == typeof global ? global : this, function () {
    "use strict";
    var e = e || {}, n = document.querySelectorAll.bind(document), a = Object.prototype.toString,
        r = "ontouchstart" in window, l = !1;
    try {
    ...
    function u(t) {
        var e, i, n, s, o = {top: 0, left: 0}, a = t && t.ownerDocument;
        return e = a.documentElement, void 0 !== t.getBoundingClientRect && (o = t.getBoundingClientRect()), i = null !== (s = n = a) && s === s.window ? n : 9 === n.nodeType && n.defaultView, {
    ...
    var p = {
        duration: 750, delay: 200, show: function (t, e, i) {
            ...
            var s = u(e), o = 0, a = 0;
            a = 0 <= (a = "touches" in t && t.touches.length ? (o = t.touches[0].pageY - s.top, t.touches[0].pageX - s.left) : (o = t.pageY - s.top, t.pageX - s.left)) ? a : 0, o = 0 <= o ? o : 0;
            ...
            n.classList.add("waves-notransition"), n.setAttribute("style", c(h)), n.classList.remove("waves-notransition"), h["-webkit-transform"] = r + " " + l, h["-moz-transform"] = r + " " + l, h["-ms-transform"] = r + " " + l, h["-o-transform"] = r + " " + l, h.transform = r + " " + l, h.opacity = "1";
            ...
            r && (e.removeEventListener("touchend", p.hide), e.removeEventListener("touchcancel", p.hide)), e.removeEventListener("mouseup", p.hide), e.removeEventListener("mouseleave", p.hide)
        }
    }, h = {
        input: function (t) {
            var e = t.parentNode;
        ...
        if (null !== i) {
            ...
            if (v.registerEvent(e), "touchstart" === e.type && p.delay) {
                var n = !1, s = setTimeout(function () {
                    s = null, p.show(e, i)
                }, p.delay), o = function (t) {
                    s && (clearTimeout(s), s = null, p.show(e, i)), n || (n = !0, p.hide(t, i)), a()
                }, t = function (t) {
                    s && (clearTimeout(s), s = null), o(t), a()
                };
                i.addEventListener("touchmove", t, l), i.addEventListener("touchend", o, l), i.addEventListener("touchcancel", o, l);
                var a = function () {
                    i.removeEventListener("touchmove", t), i.removeEventListener("touchend", o), i.removeEventListener("touchcancel", o)
                }
            } else p.show(e, i), r && (i.addEventListener("touchend", p.hide, l), i.addEventListener("touchcancel", p.hide, l)), i.addEventListener("mouseup", p.hide, l), i.addEventListener("mouseleave", p.hide, l)
        }
    }

    return e.init = function (t) {
        var e = document.body;
        "duration" in (t = t || {}) && (p.duration = t.duration), "delay" in t && (p.delay = t.delay), r && (e.addEventListener("touchstart", i, l), e.addEventListener("touchcancel", v.registerEvent, l), e.addEventListener("touchend", v.registerEvent, l)), e.addEventListener("mousedown", i, l)
    }, e.attach = function (t, e) {
        var i, n;
        t = d(t), "[object Array]" === a.call(e) && (e = e.join(" ")), e = e ? " " + e : "";
        for (var s = 0, o = t.length; s < o; s++) n = (i = t[s]).tagName.toLowerCase(), -1 !== ["input", "img"].indexOf(n) && (h[n](i), i = i.parentElement), -1 === i.className.indexOf("waves-effect") && (i.className += " waves-effect" + e)
    }, e.ripple = function (t, e) {
        var i = (t = d(t)).length;
        if ((e = e || {}).wait = e.wait || 0, e.position = e.position || null, i) for (var n, s, o, a = {}, r = 0, l = {
            type: "mousedown",
            button: 1
        }, h = function (t, e) {
            return function () {
        ...
        }; r < i; r++) if (n = t[r], s = e.position || {
            x: n.clientWidth / 2,
            y: n.clientHeight / 2
        }, o = u(n), a.x = o.left + s.x, a.y = o.top + s.y, l.pageX = a.x, l.pageY = a.y, p.show(l, n), 0 <= e.wait && null !== e.wait) {
            setTimeout(h({type: "mouseup", button: 1}, n), e.wait)
        }
    }, e.calm = function (t) {
        for (var e = {type: "mouseup", button: 1}, i = 0, n = (t = d(t)).length; i < n; i++) p.hide(e, t[i])
...
!function (t) {
    ...
    return M
}) : "undefined" == typeof exports || exports.nodeType || ("undefined" != typeof module && !module.nodeType && module.exports && (exports = module.exports = M), exports.default = M), M.version = "1.2.0", M.keys = {
    TAB: 9,
    ENTER: 13,
    ESC: 27,
    ARROW_UP: 38,
...
document.addEventListener("keydown", docHandleKeydown, !0), document.addEventListener("keyup", docHandleKeyup, !0), document.addEventListener("focus", docHandleFocus, !0), document.addEventListener("blur", docHandleBlur, !0), M.initializeJqueryWrapper = function (n, s, o) {
    jQuery.fn[s] = function (e) {
        if (n.prototype[e]) {
            ...
            if ("get" !== e.slice(0, 3)) return this.each(function () {
                var t = this[o];
                t[e].apply(t, i)
            });
...
M.anime = function () {
    ...
    function o(t) {
        return D.arr(t) ? t : (D.str(t) && (t = s(t) || t), t instanceof NodeList || t instanceof HTMLCollection ? [].slice.call(t) : [t])
    }
    ...
    function v(t, e) {
        return D.dom(t) && a($, e) ? "transform" : D.dom(t) && (t.getAttribute(e) || D.svg(t) && t[e]) ? "attribute" : D.dom(t) && "transform" !== e && w(t, e) ? "css" : null != t[e] ? "object" : void 0
    }
    ...
    function f(t, e) {
        switch (v(t, e)) {
            case"transform":
                return function (t, i) {
                    var e = h(i), e = -1 < i.indexOf("scale") ? 1 : 0 + e;
                    if (!(t = t.style.transform)) return e;
                    for (var n = [], s = [], o = [], a = /(\w+)\((.+?)\)/g; n = a.exec(t);) s.push(n[1]), o.push(n[2]);
    ...
    function y(t) {
        ...
        switch (t.tagName.toLowerCase()) {
            ...
            case"line":
                return g({x: t.getAttribute("x1"), y: t.getAttribute("y1")}, {
                    x: t.getAttribute("x2"),
                    y: t.getAttribute("y2")
                });
            case"polyline":
    ...
    function _(t, e) {
        var i, n = /-?\d*\.?\d+/g;
        if (i = D.pth(t) ? t.totalLength : t, D.col(i)) if (D.rgb(i)) {
            var s = /rgb\((\d+,\s*[\d]+,\s*[\d]+)\)/g.exec(i);
            i = s ? "rgba(" + s[1] + ",1)" : i
        } else i = D.hex(i) ? function (t) {
    ...
    function E(t, i) {
        ...
        if (D.arr(t)) {
            var n = t.length;
            2 !== n || D.obj(t[0]) ? D.fnc(i.duration) || (e.duration = i.duration / n) : t = {value: t}
        }
        return o(t).map(function (t, e) {
            return e = e ? 0 : i.delay, t = D.obj(t) && !D.pth(t) ? t : {value: t}, D.und(t.delay) && (t.delay = e), t
        }).map(function (t) {
            return c(t, e)
        })
    }
    ...
    function M(o, a) {
        ...
        return o.tweens.map(function (t) {
            var e = (t = function (t, e) {
                    ...
                    for (i in t) {
                        var s = p(t[i], e);
                        D.arr(s) && 1 === (s = s.map(function (t) {
                            return p(t, e)
                        })).length && (s = s[0]), n[i] = s
                    }
                    return n.duration = parseFloat(n.duration), n.delay = parseFloat(n.delay), n
                }(t, a)).value, i = f(a.target, o.name), n = r ? r.to.original : i, n = D.arr(e) ? e[0] : n,
                s = m(D.arr(e) ? e[1] : e, n), i = l(s) || l(n) || l(i);
            ...
            }(t.easing), t.elasticity = (1e3 - Math.min(Math.max(t.elasticity, 1), 999)) / 1e3, t.isPath = D.pth(e), t.isColor = D.col(t.from.original), t.isColor && (t.round = 1), r = t
        })
    }
    ...
    function n(t) {
        var e, i, n, s, o = u(O, t), a = u(B, t), r = (i = t.targets, (n = b(i)).map(function (t, e) {
            return {target: t, id: e, total: n.length}
        })), l = [], h = c(o, a);
        for (e in t) h.hasOwnProperty(e) || "targets" === e || l.push({name: e, offset: h.offset, tweens: E(t[e], a)});
        return s = l, t = k(d(r.map(function (n) {
    ...
    function L(t) {
        ...
        function c(e) {
            ...
            if (t = Object.keys(i).length) for (n = 0; n < t; n++) T || (T = w(document.body, "transform") ? "transform" : "-webkit-transform"), b.animatables[n].target.style[T] = i[n].join(" ");
        ...
        function e(t) {
            var e = b.duration, i = b.offset, n = i + b.delay, s = b.currentTime, o = b.reversed, a = u(t);
            if (b.children.length) {
                var r = b.children, l = r.length;
                if (a >= b.currentTime) for (var h = 0; h < l; h++) r[h].seek(a); else for (; l--;) r[l].seek(a)
            }
            (n <= a || !e) && (b.began || (b.began = !0, p("begin")), p("run")), i < a && a < e ? c(a) : (a <= i && 0 !== s && (c(0), o && v()), (e <= a && s !== e || !e) && (c(e), o || v())), p("update"), e <= t && (b.remaining ? (m = f, "alternate" === b.direction && (b.reversed = !b.reversed)) : (b.pause(), b.completed || (b.completed = !0, p("complete"), "Promise" in window && (y(), _ = d()))), g = 0)
        }

        t = void 0 === t ? {} : t;
        var f, m, g = 0, y = null, _ = d(), b = n(t);
        return b.reset = function () {
            var t = b.direction, e = b.loop;
            for (b.currentTime = 0, b.progress = 0, b.paused = !0, b.began = !1, b.completed = !1, b.reversed = "reverse" === t, b.remaining = "alternate" === t && 1 === e ? 2 : e, c(0), t = b.children.length; t--;) b.children[t].reset()
        }, b.tick = function (t) {
            ...
            b.paused && (b.paused = !1, m = 0, g = u(b.currentTime), R.push(b), H || P())
        }, b.reverse = function () {
    ...
    return L.version = "2.2.0", L.speed = 1, L.running = R, L.remove = function (t) {
        t = b(t);
        for (var e = R.length; e--;) for (var i = R[e], n = i.animations, s = n.length; s--;) a(t, n[s].animatable.target) && (n.splice(s, 1), n.length || i.pause())
    }, L.getValue = f, L.path = function (t, e) {
        var i = D.str(t) ? s(t)[0] : t, n = e || 100;
        return function (t) {
    ...
    }, L.bezier = S, L.easings = I, L.timeline = function (n) {
        var s = L(n);
        return s.pause(), s.duration = 0, s.add = function (t) {
            return s.children.forEach(function (t) {
                ...
                var i = e.offset;
                e.autoplay = !1, e.direction = s.direction, e.offset = D.und(i) ? t : m(i, t), s.began = !0, s.completed = !0, s.seek(e.offset), (e = L(e)).began = !0, e.completed = !0, e.duration > t && (s.duration = e.duration), s.children.push(e)
    ...
    var e = {
        ...
        return _inherits(n, Component), _createClass(n, [{
            ...
            key: "_setupTemporaryEventHandlers", value: function () {
                document.body.addEventListener("click", this._handleDocumentClickBound, !0), document.body.addEventListener("touchmove", this._handleDocumentTouchmoveBound), this.dropdownEl.addEventListener("keydown", this._handleDropdownKeydownBound)
            }
        }, {
            key: "_removeTemporaryEventHandlers", value: function () {
                document.body.removeEventListener("click", this._handleDocumentClickBound, !0), document.body.removeEventListener("touchmove", this._handleDocumentTouchmoveBound), this.dropdownEl.removeEventListener("keydown", this._handleDropdownKeydownBound)
            }
        }, {
            ...
            key: "_handleDropdownKeydown", value: function (t) {
                if (t.which === M.keys.TAB) t.preventDefault(), this.close(); else if (t.which !== M.keys.ARROW_DOWN && t.which !== M.keys.ARROW_UP || !this.isOpen) if (t.which === M.keys.ENTER && this.isOpen) {
                    ...
                    o && (0 <= this.focusedIndex && this.dropdownEl.children[this.focusedIndex].classList.remove("active"), this.focusedIndex = s, this._focusFocusedItem())
                }
            ...
            key: "_moveDropdown", value: function (t) {
                this.options.container ? h(this.options.container).append(this.dropdownEl) : t ? t.contains(this.dropdownEl) || h(t).append(this.dropdownEl) : this.$el.after(this.dropdownEl)
            }
        }, {
            ...
            key: "_focusFocusedItem", value: function () {
                0 <= this.focusedIndex && this.focusedIndex < this.dropdownEl.children.length && this.options.autoFocus && (this.dropdownEl.children[this.focusedIndex].focus({preventScroll: !0}), this.dropdownEl.children[this.focusedIndex].scrollIntoView({
                    behavior: "smooth",
                    block: "nearest",
                    inline: "nearest"
                }))
            ...
            key: "_getDropdownPosition", value: function (t) {
                this.el.offsetParent.getBoundingClientRect();
                var e = this.el.getBoundingClientRect(), i = this.dropdownEl.getBoundingClientRect(), n = i.height,
                    s = i.width, o = e.left - i.left, a = e.top - i.top, r = {left: o, top: a, height: n, width: s},
                    l = M.checkPossibleAlignments(this.el, t, r, this.options.coverTrigger ? 0 : e.height), h = "top",
                    d = this.options.alignment;
                if (a += this.options.coverTrigger ? 0 : e.height, this.isScrollable = !1, l.top || (l.bottom ? (h = "bottom", this.options.coverTrigger || (a -= e.height)) : (this.isScrollable = !0, n -= 20, l.spaceOnTop > l.spaceOnBottom ? (h = "bottom", n += l.spaceOnTop, a -= this.options.coverTrigger ? l.spaceOnTop - 20 : l.spaceOnTop - 20 + e.height) : n += l.spaceOnBottom)), !l[d]) {
                    var u = "left" === d ? "right" : "left";
                    l[u] ? d = u : l.spaceOnLeft > l.spaceOnRight ? (d = "right", s += l.spaceOnLeft, o -= l.spaceOnLeft) : (d = "left", s += l.spaceOnRight)
                }
                return "bottom" === h && (a = a - i.height + (this.options.coverTrigger ? e.height : 0)), "right" === d && (o = o - i.width + e.width), {
                    x: o,
                    y: a,
                    verticalAlignment: h,
            ...
            key: "_placeDropdown", value: function () {
                var t = function (t, e) {
                    for (var i = t.parentNode; null !== i && !h(i).is(document);) {
                        if (e(i)) return i;
                        i = i.parentNode
                    }
                    return null
                ...
                t || (t = this.dropdownEl.offsetParent ? this.dropdownEl.offsetParent : this.dropdownEl.parentNode), "static" === h(t).css("position") && h(t).css("position", "relative"), this._moveDropdown(t);
                ...
                this.dropdownEl.style.left = i.x + "px", this.dropdownEl.style.top = i.y + "px", this.dropdownEl.style.height = i.height + "px", this.dropdownEl.style.width = i.width + "px", this.dropdownEl.style.transformOrigin = ("left" === i.horizontalAlignment ? "0" : "100%") + " " + ("top" === i.verticalAlignment ? "0" : "100%")
            }
        }, {
    ...
    var i = {
        ...
        return _inherits(n, Component), _createClass(n, [{
            ...
            key: "_appendTooltipEl", value: function () {
                ...
                e.classList.add("tooltip-content"), this._setTooltipContent(e), t.appendChild(e), document.body.appendChild(t)
            }
        }, {
            key: "_setTooltipContent", value: function (t) {
                t.textContent = this.options.text, this.options.html && (console.warn("The html option is deprecated and will be removed in the future. See https://github.com/materializecss/materialize/pull/49"), d(t).append(this.options.html)), this.options.unsafeHTML && d(t).append(this.options.unsafeHTML)
            }
        }, {
    ...
    var t = {
        ...
        function s(t) {
            _classCallCheck(this, s), this.options = i.extend({}, s.defaults, t), this.htmlMessage = this.options.html, this.options.html && console.warn("The html option is deprecated and will be removed in the future. See https://github.com/materializecss/materialize/pull/49"), this.options.unsafeHTML && (this.htmlMessage = this.options.unsafeHTML), this.message = this.options.text, this.panning = !1, this.timeRemaining = this.options.displayLength, 0 === s._toasts.length && s._createContainer(), s._toasts.push(this);
        ...
        return _createClass(s, [{
            key: "_createToast", value: function () {
                var t = document.createElement("div");
                return t.classList.add("toast"), t.setAttribute("role", "alert"), t.setAttribute("aria-live", "assertive"), t.setAttribute("aria-atomic", !0), this.options.classes.length && i(t).addClass(this.options.classes), t.textContent = this.message, ("object" == typeof HTMLElement ? this.htmlMessage instanceof HTMLElement : this.htmlMessage && "object" == typeof this.htmlMessage && null !== this.htmlMessage && 1 === this.htmlMessage.nodeType && "string" == typeof this.htmlMessage.nodeName) ? t.appendChild(this.htmlMessage) : this.htmlMessage.jquery ? i(t).append(this.htmlMessage[0]) : i(t).append(this.htmlMessage), s._container.appendChild(t), t
            }
        }, {
            key: "_animateIn", value: function () {
    ...
    var e = {
        ...
        return _inherits(n, Component), _createClass(n, [{
            ...
            key: "_createDragTarget", value: function () {
                var t = document.createElement("div");
                t.classList.add("drag-target"), t.style.width = this.options.dragTargetWidth, document.body.appendChild(t), this.dragTarget = t
            }
        }, {
    ...
    var e = {
        ...
        function s(t, e) {
            _classCallCheck(this, s);
            var i = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, t, e));
            return (i.el.M_Autocomplete = i).options = p.extend({}, s.defaults, e), i.isOpen = !1, i.count = 0, i.activeIndex = -1, i.oldVal, i.$inputField = i.$el.closest(".input-field"), i.$active = p(), i._mousedown = !1, i._setupDropdown(), i._setupEventHandlers(), i
        }
        ...
        return _inherits(s, Component), _createClass(s, [{
            ...
            key: "_setupDropdown", value: function () {
                var e = this;
                this.container = document.createElement("ul"), this.container.id = "autocomplete-options-" + M.guid(), p(this.container).addClass("autocomplete-content dropdown-content"), this.$inputField.append(this.container), this.el.setAttribute("data-target", this.container.id);
                var t = p.extend({}, s.defaults.dropdownOptions, this.options.dropdownOptions), i = t.onItemClick;
                t.onItemClick = function (t) {
                    e.selectOption(p(t)), i && "function" == typeof i && i.call(e.dropdown, e.el)
                }, this.dropdown = M.Dropdown.init(this.el, t), this.el.removeEventListener("click", this.dropdown._handleClickBound)
            }
        }, {
            ...
            key: "_handleInputKeydown", value: function (t) {
                s._keydown = !0;
                var e = t.keyCode, i = void 0, n = p(this.container).children("li").length;
                e === M.keys.ENTER && 0 <= this.activeIndex ? (i = p(this.container).children("li").eq(this.activeIndex)).length && (this.selectOption(i), t.preventDefault()) : e !== M.keys.ARROW_UP && e !== M.keys.ARROW_DOWN || (t.preventDefault(), e === M.keys.ARROW_UP && 0 < this.activeIndex && this.activeIndex--, e === M.keys.ARROW_DOWN && this.activeIndex < n - 1 && this.activeIndex++, this.$active.removeClass("active"), 0 <= this.activeIndex && (this.$active = p(this.container).children("li").eq(this.activeIndex), this.$active.addClass("active"), this.container.children[this.activeIndex].scrollIntoView({
                    behavior: "smooth",
                    block: "nearest",
                    inline: "nearest"
                })))
            ...
            key: "_highlight", value: function (t, e) {
                var i = e.toLowerCase().indexOf("" + t.toLowerCase()), n = i + t.length - 1;
                return -1 == i || -1 == n ? [e, "", ""] : [e.slice(0, i), e.slice(i, n + 1), e.slice(n + 1)]
            }
        }, {
            ...
            key: "_resetAutocomplete", value: function () {
                p(this.container).empty(), this._resetCurrentElement(), this.oldVal = null, this.isOpen = !1, this._mousedown = !1
            }
        }, {
            ...
            key: "_renderDropdown", value: function (t, i) {
                ...
                for (var a = 0; a < e.length; a++) {
                    var r = e[a], l = document.createElement("li");
                    if (r.data) {
                        var h = document.createElement("img");
                        h.classList.add("right", "circle"), h.src = r.data, l.appendChild(h)
                    }
                    var d = this._highlight(i, r.key), u = document.createElement("span");
                    if (this.options.allowUnsafeHTML) u.innerHTML = d[0] + '<span class="highlight">' + d[1] + "</span>" + d[2]; else if (u.appendChild(document.createTextNode(d[0])), d[1]) {
                        var c = document.createElement("span");
                        c.textContent = d[1], c.classList.add("highlight"), u.appendChild(c), u.appendChild(document.createTextNode(d[2]))
                    }
    ...
    var n = ["input:not([type])", "input[type=text]", "input[type=password]", "input[type=email]", "input[type=url]", "input[type=tel]", "input[type=number]", "input[type=search]", "input[type=date]", "input[type=time]", "input[type=month]", "input[type=datetime-local]", "textarea"].join(",");
        ...
        return _inherits(l, Component), _createClass(l, [{
            ...
            key: "_handleInputKeydown", value: function (t) {
                if (l._keydown = !0, 13 === t.keyCode) {
                    ...
                    t.preventDefault(), (!this.hasAutocomplete || this.hasAutocomplete && !this.options.autocompleteOnly) && this.addChip({tag: this.$input[0].value}), this.$input[0].value = ""
            ...
            key: "_handleChipsKeydown", value: function (t) {
                ...
                if (!h(t.target).is("input, textarea") && i) {
                    ...
                    if (8 === t.keyCode || 46 === t.keyCode) {
                        ...
                        n.chipsData.length ? n.selectChip(s) : n.$input[0].focus()
            ...
            key: "_handleChipsBlur", value: function (t) {
                !l._keydown && document.hidden && (h(t.target).closest(".chips")[0].M_Chips._selectedChip = null)
            }
        }, {
            key: "defaults", get: function () {
                return e
    ...
    var e = {top: 0, bottom: 1 / 0, offset: 0, onPositionChange: null}, t = function (t) {
        ...
        return _inherits(n, Component), _createClass(n, [{
            key: "destroy", value: function () {
                ...
                n._pushpins.splice(t, 1), 0 === n._pushpins.length && this._removeEventHandlers(), this.el.M_Pushpin = void 0
            }
        }, {
            key: "_setupEventHandlers", value: function () {
    ...
    var e = {
        ...
        return _inherits($, Component), _createClass($, [{
            ...
            key: "_insertHTMLIntoDOM", value: function () {
                if (this.options.showClearBtn && (g(this.clearBtn).css({visibility: ""}), this.clearBtn.innerHTML = this.options.i18n.clear), this.doneBtn.innerHTML = this.options.i18n.done, this.cancelBtn.innerHTML = this.options.i18n.cancel, this.options.container) {
                    var t = this.options.container;
                    this.options.container = t instanceof HTMLElement ? t : document.querySelector(t), this.$modalEl.appendTo(this.options.container)
            ...
            key: "toString", value: function (t) {
                var e = this;
                return "function" == typeof (t = t || this.options.format) ? t(this.date) : $._isDate(this.date) ? t.split(/(d{1,4}|m{1,4}|y{4}|yy|!.)/g).map(function (t) {
            ...
            key: "setDate", value: function (t, e) {
                ...
                if ("string" == typeof t && (t = new Date(Date.parse(t))), $._isDate(t)) {
                    ...
                    $._isDate(i) && t < i ? t = i : $._isDate(n) && n < t && (t = n), this.date = new Date(t.getTime()), this._renderDateDisplay(), $._setToStartOfDay(this.date), this.gotoDate(this.date), e || "function" != typeof this.options.onSelect || this.options.onSelect.call(this, this.date)
                }
            }
        }, {
            ...
            key: "_renderDateDisplay", value: function () {
                var t = $._isDate(this.date) ? this.date : new Date, e = this.options.i18n,
            ...
            key: "render", value: function (t, e, i) {
                var n = this.options, s = new Date, o = $._getDaysInMonth(t, e), a = new Date(t, e, 1).getDay(), r = [],
                    l = [];
                $._setToStartOfDay(s), 0 < n.firstDay && (a -= n.firstDay) < 0 && (a += 7);
                for (var h = 0 === e ? 11 : e - 1, d = 11 === e ? 0 : e + 1, u = 0 === e ? t - 1 : t, c = 11 === e ? t + 1 : t, p = $._getDaysInMonth(u, h), v = o + a, f = v; 7 < f;) f -= 7;
                v += 7 - f;
                for (var m = !1, g = 0, y = 0; g < v; g++) {
                    var _ = new Date(t, e, g - a + 1), b = !!$._isDate(this.date) && $._compareDates(_, this.date),
                        k = $._compareDates(_, s), w = -1 !== n.events.indexOf(_.toDateString()),
                        C = g < a || o + a <= g, E = g - a + 1, M = e, x = t,
                    ...
                    var B = {
                        ...
                        isSelected: b,
                        isToday: k,
                        isDisabled: n.minDate && _ < n.minDate || n.maxDate && _ > n.maxDate || n.disableWeekends && $._isWeekend(_) || n.disableDayFn && n.disableDayFn(_),
                        isEmpty: C,
                        isStartRange: L,
                        isEndRange: T,
                        isInRange: O,
                    ...
                    l.push(this.renderDay(B)), 7 == ++y && (r.push(this.renderRow(l, n.isRTL, m)), y = 0, m = !(l = []))
                }
            ...
            key: "renderTitle", value: function (t, e, i, n, s, o) {
                ...
                for (a = '<select class="datepicker-select orig-select-month" tabindex="-1">' + d.join("") + "</select>", h = g.isArray(u.yearRange) ? (l = u.yearRange[0], u.yearRange[1] + 1) : (l = i - u.yearRange, 1 + i + u.yearRange), d = []; l < h && l <= u.maxYear; l++) l >= u.minYear && d.push('<option value="' + l + '" ' + (l === i ? 'selected="selected"' : "") + ">" + l + "</option>");
                u.yearRangeReverse && d.reverse(), r = '<select class="datepicker-select orig-select-year" tabindex="-1">' + d.join("") + "</select>";
            ...
            key: "_setupVariables", value: function () {
                var e = this;
                this.$modalEl = g($._template), this.modalEl = this.$modalEl[0], this.calendarEl = this.modalEl.querySelector(".datepicker-calendar"), this.yearTextEl = this.modalEl.querySelector(".year-text"), this.dateTextEl = this.modalEl.querySelector(".date-text"), this.options.showClearBtn && (this.clearBtn = this.modalEl.querySelector(".datepicker-clear")), this.doneBtn = this.modalEl.querySelector(".datepicker-done"), this.cancelBtn = this.modalEl.querySelector(".datepicker-cancel"), this.formats = {
                    d: function () {
            ...
            key: "_handleInputChange", value: function (t) {
                var e = void 0;
                t.firedBy !== this && (e = this.options.parse ? this.options.parse(this.el.value, this.options.format) : new Date(Date.parse(this.el.value)), $._isDate(e) && this.setDate(e))
            }
        }, {
            ...
            key: "init", value: function (t, e) {
                return _get($.__proto__ || Object.getPrototypeOf($), "init", this).call(this, this, t, e)
            }
        }, {
    ...
    var e = {
        ...
        return _inherits(f, Component), _createClass(f, [{
            ...
            key: "_handleTimeInputEnterKey", value: function (t) {
                t.which === M.keys.ENTER && (t.preventDefault(), this._inputFromTextField())
            }
        }, {
            ...
            key: "_insertHTMLIntoDOM", value: function () {
                ...
                var t = this.options.container, e = t instanceof HTMLElement ? t : document.querySelector(t);
            ...
            key: "_updateTimeFromInput", value: function () {
                ...
                this.hours = +t[0] || 0, this.minutes = +t[1] || 0, this.inputHours.value = this.hours, this.inputMinutes.value = f._addLeadingZero(this.minutes), this._updateAmPmView()
            }
        }, {
            key: "showView", value: function (t, e) {
                ...
                this.currentView = t, h(this.inputHours).toggleClass("text-primary", i), h(this.inputMinutes).toggleClass("text-primary", !i), s.classList.add("timepicker-dial-out"), h(n).css("visibility", "visible").removeClass("timepicker-dial-out"), this.resetClock(e), clearTimeout(this.toggleViewTimer), this.toggleViewTimer = setTimeout(function () {
            ...
            key: "_inputFromTextField", value: function () {
                var t = "hours" === this.currentView;
                if (t) {
                    var e = this.inputHours.value;
                    if (0 < e && e < 13) this.drawClockFromTimeInput(e, t), this.showView("minutes", this.options.duration / 2), this.hours = e, this.inputMinutes.focus(); else {
                        var i = (new Date).getHours();
                        this.inputHours.value = i % 12
                    }
                } else {
                    var n = this.inputMinutes.value;
                    if (0 <= n && n < 60) this.inputMinutes.value = f._addLeadingZero(n), this.drawClockFromTimeInput(n, t), this.minutes = n, this.modalEl.querySelector(".confirmation-btns :nth-child(2)").focus(); else {
            ...
            key: "drawClockFromTimeInput", value: function (t, e) {
                var i = t * (Math.PI / (e ? 6 : 30)), n = void 0;
                this.options.twelveHour && (n = this.options.outerRadius);
                var s = Math.sin(i) * (n - this.options.tickRadius), o = -Math.cos(i) * (n - this.options.tickRadius),
                    a = Math.sin(i) * n, r = -Math.cos(i) * n;
                this.hand.setAttribute("x2", s), this.hand.setAttribute("y2", o), this.bg.setAttribute("cx", a), this.bg.setAttribute("cy", r)
            }
        }, {
            key: "setHand", value: function (t, e, i) {
                ...
                s = d * a, this.options.twelveHour ? o ? 0 === d && (d = 12) : (i && (d *= 5), 60 === d && (d = 0)) : o ? (12 === d && (d = 0), d = l ? 0 === d ? 12 : d : 0 === d ? 0 : d + 12) : (i && (d *= 5), 60 === d && (d = 0)), this[this.currentView] !== d && this.vibrate && this.options.vibrate && (this.vibrateTimer || (navigator[this.vibrate](10), this.vibrateTimer = setTimeout(function () {
                    n.vibrateTimer = null
                }, 100))), this[this.currentView] = d, o ? this.inputHours.value = d : this.inputMinutes.value = f._addLeadingZero(d);
    ...
    var e = {
        ...
        function i(t, e) {
            ...
            return (n.el.M_Carousel = n).options = k.extend({}, i.defaults, e), n.hasMultipleSlides = 1 < n.$el.find(".carousel-item").length, n.showIndicators = n.options.indicators && n.hasMultipleSlides, n.noWrap = n.options.noWrap || !n.hasMultipleSlides, n.pressed = !1, n.dragged = !1, n.offset = n.target = 0, n.images = [], n.itemWidth = n.$el.find(".carousel-item").first().innerWidth(), n.itemHeight = n.$el.find(".carousel-item").first().innerHeight(), n.dim = 2 * n.itemWidth + n.options.padding || 1, n._autoScrollBound = n._autoScroll.bind(n), n._trackBound = n._track.bind(n), n.options.fullWidth && (n.options.dist = 0, n._setCarouselHeight(), n.showIndicators && n.$el.find(".carousel-fixed-item").addClass("with-indicators")), n.$indicators = k('<ul class="indicators"></ul>'), n.$el.find(".carousel-item").each(function (t, e) {
        ...
        return _inherits(i, Component), _createClass(i, [{
            ...
            key: "_handleCarouselTap", value: function (t) {
                "mousedown" === t.type && k(t.target).is("img") && t.preventDefault(), this.pressed = !0, this.dragged = !1, this.verticalDragged = !1, this.reference = this._xpos(t), this.referenceY = this._ypos(t), this.velocity = this.amplitude = 0, this.frame = this.offset, this.timestamp = Date.now(), clearInterval(this.ticker), this.ticker = setInterval(this._trackBound, 100)
            }
        }, {
            ...
            key: "_handleCarouselClick", value: function (t) {
                ...
                if (!this.options.fullWidth) {
                    ...
                    0 !== this._wrap(this.center) - e && (t.preventDefault(), t.stopPropagation()), e < 0 ? t.clientX - t.target.getBoundingClientRect().left > this.el.clientWidth / 2 ? this.next() : this.prev() : this._cycleTo(e)
                }
            }
        }, {
            key: "_handleIndicatorClick", value: function (t) {
            ...
            key: "_scroll", value: function (t) {
                ...
                if (this.offset = "number" == typeof t ? t : this.offset, this.center = Math.floor((this.offset + this.dim / 2) / this.dim), o = -(s = (n = this.offset - this.center * this.dim) < 0 ? 1 : -1) * n * 2 / this.dim, i = this.count >> 1, u = this.options.fullWidth ? (l = "translateX(0)", 1) : (l = "translateX(" + (this.el.clientWidth - this.itemWidth) / 2 + "px) ", l += "translateY(" + (this.el.clientHeight - this.itemHeight) / 2 + "px)", 1 - p * o), this.showIndicators) {
                ...
                if (!this.noWrap || 0 <= this.center && this.center < this.count) {
                    r = this.images[this._wrap(this.center)], k(r).hasClass("active") || (this.$el.find(".carousel-item").removeClass("active"), r.classList.add("active"));
                ...
                for (a = 1; a <= i; ++a) {
                    if (d = this.options.fullWidth ? (h = this.options.dist, a === i && n < 0 ? 1 - o : 1) : (h = this.options.dist * (2 * a + o * s), 1 - p * (2 * a + o * s)), !this.noWrap || this.center + a < this.count) {
                    ...
                    if (d = this.options.fullWidth ? (h = this.options.dist, a === i && 0 < n ? 1 - o : 1) : (h = this.options.dist * (2 * a - o * s), 1 - p * (2 * a - o * s)), !this.noWrap || 0 <= this.center - a) {
                        r = this.images[this._wrap(this.center - a)];
                        var y = l + " translateX(" + (-this.options.shift + (-this.dim * a - n) / 2) + "px) translateZ(" + h + "px)";
                        this._updateItemStyle(r, d, -a, y)
                    }
                }
                if (!this.noWrap || 0 <= this.center && this.center < this.count) {
                    r = this.images[this._wrap(this.center)];
                    var _ = l + " translateX(" + -n / 2 + "px) translateX(" + s * this.options.shift * o + "px) translateZ(" + this.options.dist * o + "px)";
    ...
    var e = {onOpen: void 0, onClose: void 0}, t = function (t) {
        function n(t, e) {
            _classCallCheck(this, n);
            var i = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, t, e));
            return (i.el.M_TapTarget = i).options = I.extend({}, n.defaults, e), i.isOpen = !1, i.$origin = I("#" + i.$el.attr("data-target")), i._setup(), i._calculatePositioning(), i._setupEventHandlers(), i
        }
        ...
        return _inherits(n, Component), _createClass(n, [{
            ...
            key: "_handleDocumentClick", value: function (t) {
                I(t.target).closest(".tap-target-wrapper").length || (this.close(), t.preventDefault(), t.stopPropagation())
            }
        }, {
            ...
            key: "_calculatePositioning", value: function () {
                ...
                if (!t) for (var e = this.$origin.parents(), i = 0; i < e.length && !(t = "fixed" == I(e[i]).css("position")); i++) ;
                var n = this.$origin.outerWidth(), s = this.$origin.outerHeight(),
                    ...
                    r = window.innerWidth, l = window.innerHeight, h = r - document.documentElement.clientWidth,
                    d = r / 2, u = l / 2, c = a <= d, p = d < a, v = o <= u, f = u < o,
                    m = .25 * r <= a && a <= .75 * r, g = this.$el.outerWidth(), y = this.$el.outerHeight(),
                    _ = o + s / 2 - y / 2, b = a + n / 2 - g / 2, k = t ? "fixed" : "absolute", w = m ? g : g / 2 + n,
                    C = y / 2, E = v ? y / 2 : 0, x = c && !m ? g / 2 - n : 0, L = n, T = f ? "bottom" : "top",
                    O = 2 * n, B = O, $ = y / 2 - B / 2, D = g / 2 - O / 2, S = {};
                S.top = v ? _ + "px" : "", S.right = p ? r - b - g - h + "px" : "", S.bottom = f ? l - _ - y + "px" : "", S.left = c ? b + "px" : "", S.position = k, I(this.wrapper).css(S), I(this.contentEl).css({
                    width: w + "px",
                    height: C + "px",
                    top: E + "px",
                    right: "0px",
                    ...
                    padding: L + "px",
                    verticalAlign: T
                }), I(this.waveEl).css({top: $ + "px", left: D + "px", width: O + "px", height: B + "px"})
            }
        }, {
            key: "open", value: function () {
    ...
    var e = {classes: "", dropdownOptions: {}}, t = function (t) {
        function n(t, e) {
            _classCallCheck(this, n);
            var i = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, t, e));
            return i.$el.hasClass("browser-default") ? _possibleConstructorReturn(i) : ((i.el.M_FormSelect = i).options = u.extend({}, n.defaults, e), i.isMultiple = i.$el.prop("multiple"), i.el.tabIndex = -1, i._values = [], i.labelEl = null, i._labelFor = !1, i._setupDropdown(), i._setupEventHandlers(), i)
        }

        return _inherits(n, Component), _createClass(n, [{
            key: "destroy", value: function () {
                this._labelFor && this.labelEl.setAttribute("for", this.el.id), this._removeEventHandlers(), this._removeDropdown(), this.el.M_FormSelect = void 0
            }
        }, {
            key: "_setupEventHandlers", value: function () {
                var e = this;
                this._handleSelectChangeBound = this._handleSelectChange.bind(this), this._handleOptionClickBound = this._handleOptionClick.bind(this), this._handleInputClickBound = this._handleInputClick.bind(this), u(this.dropdownOptions).find("li:not(.optgroup)").each(function (t) {
                    t.addEventListener("click", e._handleOptionClickBound), t.addEventListener("keydown", function (t) {
                        " " !== t.key && "Enter" !== t.key || e._handleOptionClickBound(t)
                    })
            ...
            key: "_removeEventHandlers", value: function () {
                var e = this;
                u(this.dropdownOptions).find("li:not(.optgroup)").each(function (t) {
            ...
            key: "_arraysEqual", value: function (t, e) {
                if (t === e) return !0;
            ...
            key: "_selectOptionElement", value: function (e) {
                if (!u(e).hasClass("disabled") && !u(e).hasClass("optgroup")) {
                    var t = this._values.filter(function (t) {
                        return t.optionEl === e
                    })[0], i = this.getSelectedValues();
                    this.isMultiple ? this._toggleEntryFromArray(t) : (this._deselectAll(), this._selectValue(t)), this._setValueToInput();
            ...
            key: "_setupDropdown", value: function () {
                var a = this;
                this.wrapper = document.createElement("div"), u(this.wrapper).addClass("select-wrapper " + this.options.classes), this.$el.before(u(this.wrapper));
                var t = u('<div class="hide-select"></div>');
                if (u(this.wrapper).append(t), t[0].appendChild(this.el), this.el.disabled && this.wrapper.classList.add("disabled"), this.$selectOptions = this.$el.children("option, optgroup"), this.dropdownOptions = document.createElement("ul"), this.dropdownOptions.id = "select-options-" + M.guid(), u(this.dropdownOptions).addClass("dropdown-content select-dropdown " + (this.isMultiple ? "multiple-select-dropdown" : "")), this.dropdownOptions.setAttribute("role", "listbox"), this.dropdownOptions.setAttribute("aria-required", this.el.hasAttribute("required")), this.dropdownOptions.setAttribute("aria-multiselectable", this.isMultiple), this.$selectOptions.length && this.$selectOptions.each(function (t) {
                    if (u(t).is("option")) {
                        var e = a._createAndAppendOptionWithIcon(t, a.isMultiple ? "multiple" : void 0);
                        a._addOptionToValues(t, e)
                    } else if (u(t).is("optgroup")) {
                        var i = u(t).children("option"), n = "opt-group-" + M.guid(),
                            s = u('<li class="optgroup" role="group" aria-labelledby="' + n + '" tabindex="-1"><span id="' + n + '" role="presentation">' + t.getAttribute("label") + "</span></li>")[0],
                            o = [];
                        u(a.dropdownOptions).append(s), i.each(function (t) {
                            var e = a._createAndAppendOptionWithIcon(t, "optgroup-option"), i = "opt-child-" + M.guid();
                            e.id = i, o.push(i), a._addOptionToValues(t, e)
                        }), s.setAttribute("aria-owns", o.join(" "))
                    }
                }), u(this.wrapper).append(this.dropdownOptions), this.input = document.createElement("input"), this.input.id = "m_select-input-" + M.guid(), u(this.input).addClass("select-dropdown dropdown-trigger"), this.input.setAttribute("type", "text"), this.input.setAttribute("readonly", "true"), this.input.setAttribute("data-target", this.dropdownOptions.id), this.input.setAttribute("aria-readonly", "true"), this.el.disabled && u(this.input).prop("disabled", "true"), this.el.hasAttribute("aria-labelledby")) this.labelEl = document.getElementById(this.el.getAttribute("aria-labelledby")); else if ("" != this.el.id) {
                    var e = u("label[for='" + this.el.id + "']");
                    e.length && (this.labelEl = e[0], this.labelEl.removeAttribute("for"), this._labelFor = !0)
                }
                if (!this.labelEl) {
                    var i = this.el.parentElement;
                    i && (i = i.getElementsByTagName("label")[0]), i && (this.labelEl = i)
                }
                this.labelEl && "" == this.labelEl.id && (this.labelEl.id = "m_select-label-" + M.guid()), this.labelEl ? (this.labelEl.setAttribute("for", this.input.id), this.dropdownOptions.setAttribute("aria-labelledby", this.labelEl.id)) : this.dropdownOptions.setAttribute("aria-label", "");
                for (var n = this.el.attributes, s = 0; s < n.length; ++s) {
                    var o = n[s];
                    o.name.startsWith("aria-") && this.input.setAttribute(o.name, o.value)
                }
                this.input.setAttribute("role", "combobox"), this.input.setAttribute("aria-owns", this.dropdownOptions.id), this.input.setAttribute("aria-controls", this.dropdownOptions.id), this.input.setAttribute("aria-expanded", !1), u(this.wrapper).prepend(this.input), this._setValueToInput();
                var r = u('<svg class="caret" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M7 10l5 5 5-5z"/><path d="M0 0h24v24H0z" fill="none"/></svg>');
                if (u(this.wrapper).prepend(r[0]), !this.el.disabled) {
                    var l = u.extend({}, this.options.dropdownOptions);
                    l.coverTrigger = !1;
                    var h = l.onOpenEnd, d = l.onCloseEnd;
                    l.onOpenEnd = function (t) {
                        var e = u(a.dropdownOptions).find(".selected").first();
                        if (e.length && (M.keyDown = !0, a.dropdown.focusedIndex = e.index(), a.dropdown._focusFocusedItem(), M.keyDown = !1, a.dropdown.isScrollable)) {
                            var i = e[0].getBoundingClientRect().top - a.dropdownOptions.getBoundingClientRect().top;
                            i -= a.dropdownOptions.clientHeight / 2, a.dropdownOptions.scrollTop = i
                        }
                        a.input.setAttribute("aria-expanded", !0), h && "function" == typeof h && h.call(a.dropdown, a.el)
                    }, l.onCloseEnd = function (t) {
                        a.input.setAttribute("aria-expanded", !1), d && "function" == typeof d && d.call(a.dropdown, a.el)
                    }, l.closeOnClick = !1, this.dropdown = M.Dropdown.init(this.input, l)
                }
                this._setSelectedStates()
            }
        }, {
            key: "_addOptionToValues", value: function (t, e) {
                this._values.push({el: t, optionEl: e})
            }
        }, {
            key: "_removeDropdown", value: function () {
                u(this.wrapper).find(".caret").remove(), u(this.input).remove(), u(this.dropdownOptions).remove(), u(this.wrapper).before(this.$el), u(this.wrapper).remove()
            }
        }, {
            key: "_createAndAppendOptionWithIcon", value: function (t, e) {
                var i = document.createElement("li");
                i.setAttribute("role", "option"), t.disabled && (i.classList.add("disabled"), i.setAttribute("aria-disabled", !0)), "optgroup-option" === e && i.classList.add(e);
                var n = document.createElement("span");
                this.isMultiple ? n.innerHTML = '<label><input type="checkbox"' + (t.disabled ? ' disabled="disabled"' : "") + "><span>" + t.innerHTML + "</span></label>" : n.innerHTML = t.innerHTML, i.appendChild(n);
                var s = t.getAttribute("data-icon"), o = t.getAttribute("class");
                if (s) {
            ...
            key: "_selectValue", value: function (t) {
                t.el.selected = !0, t.optionEl.classList.add("selected"), t.optionEl.setAttribute("aria-selected", !0);
                var e = t.optionEl.querySelector('input[type="checkbox"]');
                e && (e.checked = !0)
            }
        }, {
            key: "_deselectValue", value: function (t) {
                t.el.selected = !1, t.optionEl.classList.remove("selected"), t.optionEl.setAttribute("aria-selected", !1);
                var e = t.optionEl.querySelector('input[type="checkbox"]');
                e && (e.checked = !1)
            }
        }, {
            key: "_deselectAll", value: function () {
                var e = this;
            ...
            key: "_isValueSelected", value: function (e) {
            ...
            key: "_getSelectedOptions", value: function () {
                return Array.prototype.filter.call(this.el.selectedOptions, function (t) {
                    return t
                })
            }
        }, {
            key: "_setValueToInput", value: function () {
                var e = this._getSelectedOptions(), t = this._values.filter(function (t) {
                    return 0 <= e.indexOf(t.el)
                }).map(function (t) {
                    return t.optionEl.querySelector("span").innerText.trim()
                });
                if (0 === t.length) {
                    var i = this.$el.find("option:disabled").eq(0);
                    if (0 < i.length && "" === i[0].value) return void (this.input.value = i.text())
                }
            ...
            key: "_setSelectedStates", value: function () {
                ...
                this._values.forEach(function (t) {
                    ...
                    u(t.optionEl).find('input[type="checkbox"]').prop("checked", e), e ? i._activateOption(u(i.dropdownOptions), u(t.optionEl)) : (u(t.optionEl).removeClass("selected"), u(t.optionEl).attr("aria-selected", !1))
                })
            }
        }, {
            key: "_activateOption", value: function (t, e) {
                e && (this.isMultiple || t.find("li.selected").removeClass("selected"), u(e).addClass("selected"), u(e).attr("aria-selected", !0))
            }
        }, {
